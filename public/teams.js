...
Object.assign(MESSAGES.en, {
  ...
  removeAllEventsConfirm: 'Remove all events from this Team? This also removes all attendance and staff assignments for those events. This cannot be undone.',
  removeAllAttendanceConfirm: 'Remove all attendance information from all events in this Team? This cannot be undone.',
...
Object.assign(MESSAGES['nl-BE'], {
  teams: 'Teams',
  teamsSubtitle: 'Beheer teams en teamoverschrijdend lidmaatschap. Teamspecifieke rollen worden binnen elk team beheerd.',
  ...
  removeAllEventsConfirm: 'Alle events van dit team verwijderen? Dit verwijdert ook alle aanwezigheid en staff-toewijzingen voor deze events. Dit kan niet ongedaan worden gemaakt.',
  removeAllAttendanceConfirm: 'Alle aanwezigheidsinformatie van alle events van dit team verwijderen? Dit kan niet ongedaan worden gemaakt.',
  deleteTeamConfirm: 'Dit team en alle bijbehorende events verwijderen? Personen die geen ander team hebben, worden ook verwijderd.',
